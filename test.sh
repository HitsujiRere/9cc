...
assert 5 "if(3==3)return 5;return 7;"
assert 7 "if(2>3)return 5;return 7;"
assert 5 "if(4<=6)return 5;else return 7;"
assert 7 "if(5<5)return 5;else return 7;"
...
assert 14 "return multi2(3+4);"
assert 21 "return sum(1,2,3,4,5,6);"
assert 7 "print2num(7, 23);return 7;"
